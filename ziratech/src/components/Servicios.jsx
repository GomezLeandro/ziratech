...
const services = [
  {
    ...
    title: "BRANDING",
    description:
      "Creamos tu identidad corporativa para que logres distinguirte de los demás de manera exitosa.",
  },
  {
    icon: "https://res.cloudinary.com/dosdl7yqj/image/upload/v1762457142/Marketing_srpbxs.png",
    title: "MARKETING DIGITAL",
    description:
      "Planificamos un plan a tu medida para que impulses tus proyectos de manera exitosa.",
  },
  {
    icon: "https://res.cloudinary.com/dosdl7yqj/image/upload/v1762457142/Disen_%C3%A2o_Grafico_cxkht7.png",
    title: "DISEÑO GRÁFICO",
    description:
      "Diseñamos la papelería, folletería y presentaciones de tu empresa para dar a conocer tus productos y servicios.",
  },
  {
    icon: "https://res.cloudinary.com/dosdl7yqj/image/upload/v1762457142/CM_mj5npw.png",
    title: "COMMUNITY MANAGER",
    description:
      "Posicionamos tu marca planificando contenido de valor para que se destaque en tus Redes Sociales.",
  },
  {
    icon: "https://res.cloudinary.com/dosdl7yqj/image/upload/v1762457142/Disen_%C3%A2o_Web_vwepr8.png",
    title: "DISEÑO WEB",
    description:
      "Desarrollamos proyectos a medida y te brindamos soporte técnico.",
  },
  {
    icon: "https://res.cloudinary.com/dosdl7yqj/image/upload/v1762457142/E-Commerce_sibnmk.png",
    title: "E-COMMERCE",
    description:
      "Llevamos adelante todas las acciones necesarias para optimizar tu imagen y aumentar tus ventas.",
  },
];

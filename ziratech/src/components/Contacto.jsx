...
const Contacto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const successMessage = "¡Mensaje enviado!, en breve alguien del equipo se pondrá en contacto. 📧";
    const errorMessage = "¡Ups! Algo salió mal... vuelva a intentarlo en unos minutos. 😕";
